...
void AddAtTheBeginning(position, position);
...
void AddAtTheBeginning(position head, position element){
...
void DeleteElementBySurename(position head, char* surname){
	position p = SearchTheElementByLastName(head,surname);
...
void InsertUsersDataAtBegginingOfList(position head){
	...
	AddAtTheBeginning(head, element);	
}
